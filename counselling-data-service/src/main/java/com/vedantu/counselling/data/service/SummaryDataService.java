...
public class SummaryDataService {
    ...
    public SummaryData getSummary() {
        ...
        SummaryData summaryData = new SummaryData(summaryDataDb.getDescription(), summaryDataDb.getDisclaimer());
    ...
    @Transactional
    public com.vedantu.counselling.data.model.SummaryData createNewSummary(String description, String disclaimer) {
        ...
        summaryData.setDisclaimer(disclaimer);
