...
import { NameConstant, quotaFilter } from '../../../core/constant/name-constant';

@Component({
  selector: 'app-quota-filter',
  templateUrl: './quota-filter.component.html',
  styleUrls: ['./quota-filter.component.css']
})
export class QuotaFilterComponent implements OnInit, OnDestroy {
  componentName: NameConstant = quotaFilter;
  config = {
  ...
  quotaDropdownControl = new FormControl('');
  constructor(
